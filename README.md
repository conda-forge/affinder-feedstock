...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/affinder-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15158&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/affinder-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `affinder` can be installed with:

```
conda install affinder
```

It is possible to list all of the versions of `affinder` available on your platform with:
